...
# Return precipitation (tutor helped me set up the date and dictionary with loop)
...
def precipitation():
   ...
   # Convert results into a dictionary of precipitation
    precip = {date: prcp for date, prcp in precip_results}
    return jsonify(precip)

# Return stations (tutor made sure my list was correct)
